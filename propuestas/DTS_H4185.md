...
* #DTS #H4185 Sistema SGA y control de fabricación. Gestión de órdenes de trabajo de almacén: Entradas, salidas, transferencias entre almacenes, transferencias entre zonas, Inventarios, Pick & Pack, Entrada > Playa > Ubicación
...
* #DTS #H4185 Sistema SGA y control de fabricación. Gestión de la configuración del paso de cada orden de trabajo de almacén: Lectura de código de barras / código de lote, ubicación origen, ubicación destino, ubicación transporte, confirmación de cantidad, exigir recuento, generar incidencia
...
### Descarga de pedido (entrada de mercancía)
+ Seleccionar pedido
...
+ Se pregunta por el artículo
    ...
    + Leer código de barras del producto / lote
...
### Picking de pedidos de salida. Transferencia desde picking > a preparación
