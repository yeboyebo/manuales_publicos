...
### Notas de desarrollo
Crear idfactura en lineaspedidoscli

Una lista es un pedido, reserva material.

Al entregar una línea:
    + Creamos un albarán completo, ligándolo a la factura si ya existe
Al facturar una línea:
    + Creamos una venta tpv / ¿factura? pendiente de pago
