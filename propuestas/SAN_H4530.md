...
Modificaremos las acciones de: + Preparar curso + Finalizar curso
...
Podremos crear y editar cursos desde la webapp, indicando: + Nombre del curso + Cliente y dirección + Fecha y hora de inicio + Fecha y hora de fin + Responsables (agentes) asociados + Gastos
